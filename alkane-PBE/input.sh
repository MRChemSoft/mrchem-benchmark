...
for prec in 5; do
    threshold=$((${prec}-1))
    for MPI in 008 016 032 064 082; do
...
run_file=mpi_082_omp_08
sed -i "s/NODES/41/"                        *${run_file}*.run
sed -i "s/TASKS/2/"                         *${run_file}*.run
sed -i "s/CPUS/8/"                          *${run_file}*.run
sed -i "s/HOURS/${full_hr}/"                *${run_file}*.run

run_file=mpi_082_omp_16
sed -i "s/NODES/41/"                        *${run_file}*.run
sed -i "s/TASKS/2/"                         *${run_file}*.run
sed -i "s/CPUS/16/"                         *${run_file}*.run
sed -i "s/HOURS/${full_hr}/"                *${run_file}*.run

run_file=mpi_082_omp_32
sed -i "s/NODES/82/"                        *${run_file}*.run
sed -i "s/TASKS/1/"                         *${run_file}*.run
sed -i "s/CPUS/32/"                         *${run_file}*.run
sed -i "s/HOURS/${full_hr}/"                *${run_file}*.run
